...
## 2026-08-18 - Tooltips and Required State for Transparent Hitzone Inputs
**Learning:** When implementing form inputs as transparent hitzones over background images, mouse users lack visual hover context and screen readers may not recognize mandatory fields if they are custom implementations.
