...
## 2026-08-15 - Form Inputs as Transparent Hitzones
**Learning:** When implementing form inputs as transparent hitzones over background images, screen readers might not announce their mandatory state without explicit attributes, and mouse users lack visual hover tooltips.
