...
## 2026-08-14 - Hover Tooltips and Required States for Transparent Input Hitzones
**Learning:** When implementing form inputs as transparent hitzones over background images, mouse users lack visual hover indicators and screen readers may not accurately announce their mandatory state.
