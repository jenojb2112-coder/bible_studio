...
**Vulnerability:** Input fields lacked `maxlength` attributes.
...
**Prevention:** Ensure explicit `maxlength` attributes (e.g., 100 for emails/names, 128 for passwords) are added on all relevant input fields.
